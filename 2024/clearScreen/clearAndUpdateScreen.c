...
int main() {
    ...
    while (1) {
        ...
        // Força o flush do buffer para garantir que as mensagens apareçam imediatamente
        fflush(stdout);

        // Aguarda 1 segundo antes da próxima iteração (simulando uma atualização de tela)
        sleep(1);
    }
